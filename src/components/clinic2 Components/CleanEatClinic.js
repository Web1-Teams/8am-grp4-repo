      ...
      <div className="main-container">
        <div className="main-frame">
          ...
          <details>
            ...
            <div class="container">
              <p>
                Learn how proper nutrition can promote hair growth. These
                easy-to-follow tips provide the nutrients your hair needs to
     ...
     2. Add the coconut milk and blend until well combined.
      ...
      5. You can either strain the juice or enjoy it as is. Serve immediately."
          ...
          <details>
            ...
            <div class="container">
              <p>
                Discover how proper nutrition can help reduce hair loss and
                promote healthier hair growth. These simple and natural tips
                focus on providing essential nutrients to strengthen hair
                follicles and improve overall scalp health.
              </p>
            </div>
            <Recipes
       ...
       4. Blend all ingredients until smooth and well combined.
        ...
        v 6. Pour the drink into a glass and enjoy its hair-strengthening benefits."
          ...
          <details>
            ...
            <div class="container">
              <p>
                Learn how proper nutrition can deeply nourish your hair, making
                it healthier, shinier, and stronger. A balanced diet rich in
                vitamins, minerals, and proteins provides the essential
                nutrients needed to maintain the strength of hair follicles and
      ...
      <div class="main-container">
        <div class="main-frame">
          ...
          <details>
            ...
            <div class="container">
              <p>
                Discover the power of natural juices to enhance your skin’s
                radiance. Packed with essential vitamins and antioxidants, these
                refreshing juice recipes are designed to nourish your skin from
                the inside out. Regularly consuming these nutrient-rich juices
                can help promote hydration, improve skin texture, and protect
                against environmental damage, giving you a healthy, glowing
                complexion.
              </p>
            </div>
            <Recipes
          ...
          <details>
            ...
            <div class="container">
              <p>
                Healthy nutrition plays a crucial role in managing acne. A
                balanced diet rich in antioxidants, vitamins, and minerals can
                help reduce inflammation and promote clear, healthy skin.
                Nutrients such as Vitamin A, Vitamin C, Zinc, and Omega-3 fatty
                acids are particularly beneficial for acne-prone skin. These
                nutrients help regulate sebum production, reduce inflammation,
                and support skin healing. Avoiding excessive sugar and processed
                foods can also help reduce acne outbreaks by preventing hormonal
                imbalances and insulin spikes. Consuming nutrient-dense foods
                can improve skin health and contribute to clearer, more radiant
                skin.
              </p>
            </div>
            <Recipes
          ...
          <details>
            ...
            <div class="container">
              <p>
                Explore effective and natural remedies to delay the appearance
                of wrinkles and maintain youthful, glowing skin. These recipes
                combine antioxidant-rich ingredients with essential vitamins to
                nourish your skin and protect against aging factors.
              </p>
            </div>
            <Recipes
      ...
      <div class="main-container">
        <div class="main-frame">
          ...
          <details>
            ...
            <div class="container">
              <p>
                A healthy diet plays a vital role in strengthening the body's
                immune system. Consuming a balanced diet rich in vitamins,
                minerals, and antioxidants boosts the body's ability to fight
                infections and diseases. Nutrients such as vitamin C, vitamin D,
                zinc, and omega-3 fatty acids enhance the production and
                function of immune cells, while also reducing inflammation. By
                supporting the immune system with the right nutrients, clean
                nutrition promotes overall health and improves the body's
          ...
          <details>
            ...
            <div class="container">
              <p>
                Discover a variety of drinks that help enhance memory and focus.
                These drinks are easy to prepare and provide your body with the
                energy needed for an active mind.
              </p>
            </div>
            <Recipes
          ...
          <details>
            ...
            <div class="container">
              <p>
                Explore a selection of drinks designed to increase energy and
                enhance vitality. These beverages are packed with essential
                nutrients to keep your body active throughout the day.
              </p>
            </div>
            <Recipes
              recipeName="Milk"
          ...
          <details>
            ...
            <div class="container">
              <p>
                Detox drinks are extracts made from fruits and vegetables that
                help deliver essential nutrients. They aid in:
                <ul>
                  <li>
                    Increasing daily intake of fruits and vegetables through
                    smoothies or fresh juices.
                  </li>
                  <li>
                    Providing a healthy, satisfying alternative to high-calorie
                    snacks.
                  </li>
                  <li>
                    Reducing inflammation, improving skin health, and boosting
                    metabolism for efficient toxin removal.
                  </li>
                </ul>
              </p>
            </div>
          ...
          <details>
            ...
            <div class="container">
              <p>
                Iron deficiency often leads to anemia. While supplements are
                recommended, increasing your intake of iron-rich beverages can
                help restore iron levels. These drinks are particularly
                important for women due to iron loss during menstruation.{" "}
              </p>
              <p>
                {" "}
                Here are iron-rich beverages to help boost your hemoglobin
                levels:
              </p>
            </div>
            <Recipes
